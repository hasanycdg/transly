      ...
      <div className="mx-auto max-w-[760px] px-5 py-16 sm:px-7 lg:px-8 lg:py-24">
        ...
        <div className="mt-16 border-t border-[var(--border)] pt-8">
          <p className="text-[13px] text-[var(--muted-soft)]">
            {isDe
              ? "Bei Fragen zum Datenschutz kontaktiere uns unter support@translayr.dev."
              : "For privacy-related questions, contact us at support@translayr.dev."}
          </p>
        </div>
      </div>
    </main>
...
const deContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      heading: "11. Kontakt",
      paragraphs: [
        "Bei Fragen zum Datenschutz erreichst du uns unter support@translayr.dev.",
...
const enContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      heading: "11. Contact",
      paragraphs: [
        "For privacy-related questions, reach us at support@translayr.dev.",
