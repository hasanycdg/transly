  ...
  const copy =
    locale === "de"
      ? {
          ...
          fileTypes: "XLIFF, .po, .strings, .resx, .xml, .csv, .txt, .docx, .pptx oder .zip",
          upload: "/ Upload",
      ...
      : {
          ...
          fileTypes: "XLIFF, .po, .strings, .resx, .xml, .csv, .txt, .docx, .pptx, or .zip",
          upload: "/ Upload",
    ...
    <section className="rounded-[10px] border border-[var(--border)] bg-white">
      ...
      >
        <input
          id={inputId}
          type="file"
          accept=".xliff,.xlf,.po,.strings,.resx,.xml,.csv,.txt,.docx,.pptx,.zip"
          multiple
          className="hidden"
        ...
        <div className="ml-auto flex flex-wrap gap-[5px]">
          {[".XLIFF", ".PO", ".strings", ".RESX", ".XML", ".CSV", ".TXT", ".DOCX", ".PPTX", ".ZIP"].map((extension) => (
            <span
              key={extension}
      ...
      >
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-0.5 text-[12px] text-[var(--muted-soft)]">
              .xliff, .po, .strings, .resx, .xml, .csv, .txt, .docx, .pptx, .zip
            </p>
          </div>
        </div>
